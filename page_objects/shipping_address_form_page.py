...
class ShippingAddressFormPage(BasePage):
    ...
    def select_shipping_option(self):
        ...
        shipping_method_section = self.find_element(self.SHIPPING_METHODS_SECTION["locator"])
    ...
    def verify_next_btn_text(self):
        self.assert_text_in_element(self.NEXT_BUTTON["locator"], self.NEXT_BUTTON["text"])
